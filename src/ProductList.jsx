                    ...
                    <div>
                        <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
                            <h1 className='cart'>
                                ...
                                <p className='cart_quantity_count'>{calculateTotalQuantity()}</p>
                            </h1>
                        </a>
                    </div>
                </div>
                        ...
                        <div key={index}> {/* Unique key for each category div */}
                            ...
                            <div className="product-list"> {/* Container for the list of plant cards */}
                                {category.plants.map((plant, plantIndex) => {// Loop through each plant in the current category
                                    const isPlantAddedToCart = addedToCart[plant.name];
                                    return (
                                        <div className="product-card" key={plantIndex}> {/* Unique key for each plant card */}
                                            ...
                                            <button
                                                disabled={isPlantAddedToCart}
                                                className={`product-button ${isPlantAddedToCart ? "added-to-cart" : null}`}
                                                onClick={() => handleAddToCart(plant)} // Handle adding plant to cart
                                            >
                                                {isPlantAddedToCart ? "Added to Cart" : "Add to Cart"}
                                            </button>
                                        </div>
                                    )
                                })}
